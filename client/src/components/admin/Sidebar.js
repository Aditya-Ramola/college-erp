      ...
      <div className={getSidebarClasses()}>
        ...
        <div className="overflow-y-auto scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-300 h-full max-h-screen pb-20">
          ...
          <div className="p-2">
            ...
            <Collapse in={openSection.admin || (!isMobile && !isTablet)} timeout="auto" unmountOnExit>
              <div className="ml-4">
                <NavLink
                  to="/admin/alladmin"
                  className={({ isActive }) => isActive ? isActiveStyle : isNotActiveStyle}
          ...
          <div className="p-2">
            ...
            <Collapse in={openSection.department || (!isMobile && !isTablet)} timeout="auto" unmountOnExit>
              <div className="ml-4">
                <NavLink
          ...
          <div className="p-2">
            ...
            <Collapse in={openSection.faculty || (!isMobile && !isTablet)} timeout="auto" unmountOnExit>
              <div className="ml-4">
                <NavLink
                  to="/admin/allfaculty"
                  className={({ isActive }) => isActive ? isActiveStyle : isNotActiveStyle}
          ...
          <div className="p-2">
            ...
            <Collapse in={openSection.student || (!isMobile && !isTablet)} timeout="auto" unmountOnExit>
              <div className="ml-4">
                <NavLink
                  to="/admin/allstudent"
                  className={({ isActive }) => isActive ? isActiveStyle : isNotActiveStyle}
          ...
          <div className="p-2">
            ...
            <Collapse in={openSection.subject || (!isMobile && !isTablet)} timeout="auto" unmountOnExit>
              <div className="ml-4">
                <NavLink
                  to="/admin/allsubject"
                  className={({ isActive }) => isActive ? isActiveStyle : isNotActiveStyle}
