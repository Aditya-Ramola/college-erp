...
router.get("/public/departments", getAllDepartment); // Public endpoint for departments
...
router.get("/pendingstudents", auth, getPendingStudentRegistrations);
router.post("/updatestudentregistration", auth, updateStudentRegistrationStatus);
